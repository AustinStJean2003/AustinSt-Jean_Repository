...
namespace HVK.Models
{
    public partial class Customer
    {
        ...
        [StringLength(25, ErrorMessage = "First lame cannot be longer than 25 characters")]
        ...
        [DataType(DataType.Text)]
        [StringLength(25)]
        [PhoneValidation("Phone", "Email", ErrorMessage = "Either phone number or email is required.")]
        [RegularExpression("^[0-9]{10}$", ErrorMessage = "Must Follow pattern XXX-XXX-XXXX")]
