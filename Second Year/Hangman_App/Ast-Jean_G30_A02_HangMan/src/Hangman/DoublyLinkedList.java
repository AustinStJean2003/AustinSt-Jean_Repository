...
public class DoublyLinkedList<E>
{
	...
	public DLNode<E> addAtEnd(E target) {
		if (target == null) {
			return null;
		}
		DLNode<E> endCursor = new DLNode<E>(target, tail.getPredecessor(), tail);
		tail.getPredecessor().setSuccessor(endCursor);
		tail.setPredecessor(endCursor);
		length++;
		return endCursor;
	}
